...
class StaticContext(BaseModel):
    ...
    summarization_model: str = Field(default="gemini-2.5-pro", description="针对联网搜索结果进行总结的模型选择")
    ...
    final_report_model: str = Field(default="gemini-2.5-pro", description="撰写研究报告的模型选择")
