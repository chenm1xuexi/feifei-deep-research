...
class StaticContext(BaseModel):
    ...
    summarization_model: str = Field(default="google/gemini-2.5-pro", description="针对联网搜索结果进行总结的模型选择")
    ...
    research_model: str = Field(default="google/gemini-2.5-pro", description="进行深度研究的模型选择")
    ...
    compression_model: str = Field(default="google/gemini-2.5-pro",
    ...
    final_report_model: str = Field(default="google/gemini-2.5-pro", description="撰写研究报告的模型选择")
