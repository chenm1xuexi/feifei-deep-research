...
3. **mcp tools**: Provides additional model context protocol toolset to assist research

**CRITICAL: Use think_tool after each search to reflect on results and plan next steps.
 Do not call think_tool with the web_search_tool or any other tools. It should be to reflect on the results of the search.**
</Available Tools>
